def binary_search(array, low_index, high_index, value):
    ...
    # o -1 e o +1 no binary_search é para já descartar o valor do middle_index já que sabemos
    # que ele não é o valor procurado. Se o valor procurado for menor que o middle index
    # devemos chamar binary_search com middle_index como high_index, mas com - 1, já que podemos
    # descartar o middle index; se o valor procurado for maior que o middle index, devemos chamar binary_search com o low_index com o valor de middle_index + 1, +1 pq sabemos que o 0 seria o valor inicial da próxima busca, mas já sabemos que o 0 é o middle_index que não é o valor que buscamos
