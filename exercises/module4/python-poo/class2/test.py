...
class SalesReport(ABC):
   ...
   # o compressor=GzCompressor() significa que vai receber o compressor Gz como default, a não ser que outro compressor seja escolhido na hora da instanciar a classe 
